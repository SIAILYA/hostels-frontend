        ...
        <Panel id={id}>
            ...
            <Div style={{paddingBottom: "20vh"}}>
                ...
                <div style={{textAlign: "center", marginTop: "25px"}}>
                    Наши креативометры зашкаливают, вам явно нужно поучаствовать в битве за лучший отзыв! Для этого нужно разрешить сообществу отправлять вам сообщения. Обещаем без лишних рассылок!
                </div>
            </Div>
            <FixedLayout
                vertical="bottom"
